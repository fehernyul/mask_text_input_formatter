...
class MaskTextInputFormatter implements TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(TextEditingValue oldValue, TextEditingValue newValue) {
    ...
    int beforeSelectionLength = 0;
    if (afterSelection.isValid) {
      if (beforeSelection.isValid) {
        beforeSelectionLength = beforeSelection.end - beforeSelectionStart; //1
        if ((afterText.length < beforeText.length) && (beforeSelection.end == afterSelection.end)) {
      ...
      beforeSelectionLength = oldValue.text.length;
    }
